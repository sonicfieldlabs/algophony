  ...
  return (
    <>
      <div className="page-header">
        <h1 className="page-title">{generation.audio_id}</h1>
      ...
      <div className="compare-grid">
        <div className="detail-section">
          ...
          <div className="card">
            ...
            <div className="detail-row"><span className="detail-label">Seed</span><span className="detail-value">{String(generation.seed)}</span></div>
        ...
        <div className="detail-section">
          ...
          <div className="card">
            <div className="detail-row"><span className="detail-label">SHA-256</span><span className="detail-value hash-value">{generation.sha256}</span></div>
        ...
        <div className="card-grid">
          {reports.map((report) => (
            <div className="card compact-card" key={report.report_id}>
              <div className="card-title"><Link href={`/reports/${report.report_id}`}>{report.report_id}</Link></div>
