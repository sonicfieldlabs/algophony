import { getPrompts, getGenerations, getReports } from "../../lib/data";
        ...
        {generations.length > 0 ? (
          <div className="card" style={{ overflowX: "auto" }}>
            <table className="data-table">
              <thead><tr><th>Audio ID</th><th>Model</th><th>Duration</th><th>Date</th></tr></thead>
              <tbody>
                {generations.map((g) => (
                  <tr key={g.audio_id}>
          ...
          <div className="card-grid">
            {reports.map((r) => (
              <div className="card" key={r.report_id}>
                ...
                <div className="card-meta">{r.listener_type} · {r.listening_date}</div>
