...
def sanitize_text_files(out_dir: Path, dry_run: bool) -> list[str]:
    ...
    for path in out_dir.rglob("*"):
        ...
        updated = updated.replace(f"{user_root}/Documents/SFL/algophony", "$SFL_ROOT/algophony")
        updated = updated.replace(f"{user_root}/Documents/SFL/akouo", "$SFL_ROOT/akouo")
        updated = updated.replace(f"{user_root}/Documents/SFL/bench", "$SFL_ROOT/bench")
        updated = updated.replace(f"{user_root}/Documents/SFL/sonic field labs", "$SFL_ROOT/sonic-field-labs")
