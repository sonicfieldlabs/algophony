...
The reports are agentic artifacts. Signal-only evidence remains distinct from
AKOÚŌ-style claims, and publication-level heard claims require a later,
separately attributable human listening pass.
"""
